...
if(cacao_report[['eval']][['hereditary']] == T){
  ...
  for(clevel in c('high','callable','low','no_coverage')){
    if(nrow(cacao_report[['loci']][['hereditary']][[clevel]]) > 0){
      ...
      missing_tab[['hereditary']][[clevel]] <- F
    }
  }
}
...
```{r hereditary_high_cov_missing, echo=F, results = 'asis', eval = !eval_tab[['hereditary']][['high']]}
cat("#### High coverage\n")
...
```{r hereditary_callable_missing, echo=F, results = 'asis', eval = !eval_tab[['hereditary']][['callable']]}
cat("#### Callable\n")
...
```{r hereditary_low_missing, echo=F, results = 'asis', eval = !eval_tab[['hereditary']][['low']]}
cat("#### Low coverage\n")
...
```{r hereditary_nocov_missing, echo=F, results = 'asis', eval = !eval_tab[['hereditary']][['no_coverage']]}
cat("#### No coverage\n")
